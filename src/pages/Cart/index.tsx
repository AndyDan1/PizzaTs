...
const Cart:React.FC = () => {
  ...
  const test = items.reduce((acc:number, obj) => acc += obj.count, 0)
      ...
      <div className="cart">
        ...
        <div className="cart__bottom">
          <div className="cart__bottom-details">
            <span> Всего пицц: <b>{test} шт.</b> </span>
            <span> Сумма заказа: <b>{totalPrice} ГРН</b> </span>
          </div>
          <div className="cart__bottom-buttons">
            <Link to={books.home} className="button button--outline button--add go-back-btn">
